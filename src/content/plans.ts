...
export const PLANOS: Plan[] = [
  {
    ...
    beneficios: [
      "Acesso a todos os 9 módulos do CS0-003",
      "Banco de questões com explicação comentada",
      "Simulados cronometrados por domínio",
  ...
  },
  {
    ...
    beneficios: [
      ...
      "Simulado completo de 85 questões (modo prova)",
  ...
  },
  {
    id: "anual",
    nome: "Anual",
    descricao: "Melhor custo por mês e cobertura até a renovação da certificação.",
    precoCentavos: 39700,
    ...
    beneficios: [
      ...
      "Laboratórios guiados (SIEM, triagem e resposta)",
      "Atualizações de conteúdo durante todo o ano",
