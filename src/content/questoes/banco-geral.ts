...
/**
 * Banco geral por domínio, usado nos simulados livres e no simulado em modo
 * prova. Questões de checkpoint de seção ficam nos arquivos `sNN.ts`.
 */
export const BANCO_GERAL: Questao[] = [
  {
    id: "q01",
    dominio: "d1",
    enunciado:
