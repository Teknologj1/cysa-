import CheckoutButton from "@/features/assinatura/components/CheckoutButton";
import { type Plan, formatarBRL } from "@/content/planos";

export default function PlanoCard({ plano }: { plano: Plan }) {
  return (
    <div
